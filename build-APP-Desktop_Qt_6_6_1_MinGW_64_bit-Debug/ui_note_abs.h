...
public:
    ...
    void setupUi(QDialog *Note_Abs)
    {
        if (Note_Abs->objectName().isEmpty())
            Note_Abs->setObjectName("Note_Abs");
        ...
        texte_CNE_Abs->setObjectName("texte_CNE_Abs");
        ...
        texte_Id_Abs->setObjectName("texte_Id_Abs");
        ...
        texte_Nbr_Abs->setObjectName("texte_Nbr_Abs");
        ...
        texte_CNE_Note->setObjectName("texte_CNE_Note");
        ...
        texte_Id_Note->setObjectName("texte_Id_Note");
        ...
        texte_Note->setObjectName("texte_Note");
        ...
        pushButton_supprimer_4->setObjectName("pushButton_supprimer_4");

        horizontalLayout_20->addWidget(pushButton_supprimer_4);

        pushButton_afficher_4 = new QPushButton(horizontalLayoutWidget_4);
        pushButton_afficher_4->setObjectName("pushButton_afficher_4");
